...
ops.fbinary             = 'ephys_02_06_dead_channels.dat'; % will be created for 'openEphys'		
ops.fproc               = '/media/behrenslab/My Passport/backup_laptop_ephys/2018-06-02_17-51-37/temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = '/media/behrenslab/My Passport/backup_laptop_ephys/2018-06-02_17-51-37'; % 'openEphys' only: where raw files are		
...
ops.chanMap             = '/media/behrenslab/My Passport/KiloSort_Ephys/Veronika_ChanMapping_Pin_1_32_Edge_Both_shank.mat'; % make this file using createChannelMapFile.m		
